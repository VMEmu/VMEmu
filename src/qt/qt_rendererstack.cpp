    ...
    , ui(new Ui::RendererStack)
{
    ...
    mousedata.mouse_type = getenv("EMUvmemu_MOUSE");
        ...
        case Renderer::Vulkan:
            {
                ...
                try {
                    ...
                    auto msgBox = new QMessageBox(QMessageBox::Critical, "VMEmu", e.what() + QString("\nFalling back to software rendering."), QMessageBox::Ok);
                ...
                connect(hw, &VulkanWindowRenderer::errorInitializing, [=]() {
                    ...
                    auto msgBox = new QMessageBox(QMessageBox::Critical, "VMEmu", QString("Failed to initialize Vulkan renderer.\nFalling back to software rendering."), QMessageBox::Ok);
                    msgBox->setAttribute(Qt::WA_DeleteOnClose);
                    msgBox->show();
                    imagebufs = {};
                    QTimer::singleShot(0, this, [this]() { switchRenderer(Renderer::Software); });
