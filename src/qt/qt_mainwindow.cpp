...
MainWindow::closeEvent(QCloseEvent *event)
{
    ...
    if (confirm_exit && confirm_exit_cmdl && cpu_thread_run) {
        QMessageBox questionbox(QMessageBox::Icon::Question, "VMEmu", tr("Are you sure you want to exit 86Box?"), QMessageBox::Yes | QMessageBox::No, this);
...
MainWindow::initRendererMonitorSlot(int monitor_index)
{
    ...
    if (secondaryRenderer) {
        ...
        secondaryRenderer->setWindowTitle(QObject::tr("VMEmu Monitor #") + QString::number(monitor_index + 1));
...
{
    if (confirm_reset) {
        QMessageBox questionbox(QMessageBox::Icon::Question, "VMEmu", tr("Are you sure you want to hard reset the emulated machine?"), QMessageBox::NoButton, this);
...
#    define DYNAREC_STR "no dynarec"
    ...
    msgBox.setText(QString("<b>%3%1%2</b>").arg(EMU_VERSION_FULL, versioninfo, tr("VMEmu v")));
    ...
    msgBox.setWindowTitle("About VMEmu");
